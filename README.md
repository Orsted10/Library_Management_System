# Desi Library Management System PRO MAX
...
First, you'll be greeted by a security check. Once you're in, the powerful main menu appears.
  ...
  *(You can upload a screenshot to a site like Imgur and paste the link here)*
...
Safely add a book with duplicate ID prevention. We now use `fgets()` instead of the dangerous `gets()` to be safe from buffer overflows.
...
[5](https://www.codewithfaraz.com/c/82/how-to-create-library-management-system-in-c-programming)
[6](https://github.com/topics/library-management-system?l=c)
[7](https://www.cppbuzz.com/projects/c/library-management-in-c)
[8](https://www.slideshare.net/slideshow/library-management-system-71156504/71156504)
[9](https://www.youtube.com/watch?v=OK0i9yImsig)
